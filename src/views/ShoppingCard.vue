<template>
    <div class="shopping-cart" :class="{ active: isActive }"> 
 
    <div class="box"> 
        <i class="ri-close-line close-icon"></i> 
        <img src="/src/image/cart-img-1.jpg" alt=""> 
        <div class="content"> 
    ...
    <div class="box"> 
        <i class="ri-close-line close-icon"></i> 
        <img src="/src/image/cart-img-2.jpg" alt=""> 
        <div class="content"> 
            <h3>современная мебель</h3> 
            <span class="quantity"> 1 </span> 
            <span class="multiply"> x </span> 
    ...
    <div class="box"> 
        <i class="ri-close-line close-icon"></i> 
        <img src="/src/image/cart-img-3.jpg" alt=""> 
        <div class="content"> 
            <h3>современная мебель</h3> 
            <span class="quantity"> 1 </span> 
            <span class="multiply"> x </span> 
    ...
    <div class="box"> 
        <i class="ri-close-line close-icon"></i> 
        <img src="/src/image/cart-img-4.jpg" alt=""> 
        <div class="content"> 
            <h3>современная мебель</h3> 
            <span class="quantity"> 1 </span> 
            <span class="multiply"> x </span> 
    ...
    <h3 class="total"> итог: <span>$560.00</span></h3> 
